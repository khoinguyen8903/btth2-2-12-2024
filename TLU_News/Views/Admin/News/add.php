...
<body>
    <div class="container">
        ...
        <form action="index.php?controller=news&action=add" method="POST" class="form">
            <label for="title">Tiêu đề:</label>
            <input type="text" id="title" name="title" required class="input-text">

            <label for="content">Nội dung:</label>
            <textarea id="content" name="content" required class="input-textarea"></textarea>

            <label for="image">Hình ảnh:</label>
            <input type="text" id="image" name="image" required class="input-text">

            <label for="category_id">Danh mục:</label>
            <input type="number" id="category_id" name="category_id" required class="input-text">
